...
def _parse_frontmatter(skill_path: str) -> dict[str, str]:
    ...
    if not skill_md.is_file():
        raise EvalError(
            code="E_NO_SKILL_MD",
            what=f"SKILL.md not found in {skill_path}",
            why="A SKILL.md file is required to extract skill metadata for scaffold generation",
            fix="Create a SKILL.md file in the skill directory, or run 'skillctl init' first",
        )
